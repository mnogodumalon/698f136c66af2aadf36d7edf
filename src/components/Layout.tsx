...
const externalNavigation = [
  { name: 'Räume', href: '/gateway/apps/698f133d8617092fb0ba101c?template=list_page', icon: IconDoorEnter },
  { name: 'Dozenten', href: '/gateway/apps/698f1344b2f96ffd533fd861?template=list_page', icon: IconSchool },
  { name: 'Anmeldungen', href: '/gateway/apps/698f134539995ecb193f525c?template=list_page', icon: IconClipboardList },
  { name: 'Kurse', href: '/gateway/apps/698f134492fcb1ed5433f800?template=list_page', icon: IconBook },
  { name: 'Teilnehmer', href: '/gateway/apps/698f134577641afcf6ad489b?template=list_page', icon: IconUsers },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/698f133d8617092fb0ba101c?template=list_page"
