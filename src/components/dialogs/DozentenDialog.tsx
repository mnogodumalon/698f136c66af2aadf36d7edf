...
export function DozentenDialog({ open, onClose, onSubmit, defaultValues, enablePhotoScan = true, enablePhotoLocation = true }: DozentenDialogProps) {
      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              id="dozent_firstname"
              value={fields.dozent_firstname ?? ''}
              onChange={e => setFields(f => ({ ...f, dozent_firstname: e.target.value }))}
            />
          </div>
          <div className="space-y-2">
            ...
            <Input
              id="dozent_lastname"
              value={fields.dozent_lastname ?? ''}
              onChange={e => setFields(f => ({ ...f, dozent_lastname: e.target.value }))}
            />
          </div>
          <div className="space-y-2">
