...
export function KurseDialog({ open, onClose, onSubmit, defaultValues, raeumeList, dozentenList, enablePhotoScan = true, enablePhotoLocation = true }: KurseDialogProps) {
  ...
  async function handlePhotoScan(file: File) {
    ...
    try {
      ...
      setFields(prev => {
        ...
        if (dozentName) {
          const dozentMatch = dozentenList.find(r => matchName(dozentName!, [String(r.fields.dozent_firstname ?? '')]));
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <SelectContent>
                ...
                {dozentenList.map(r => (
                  <SelectItem key={r.record_id} value={r.record_id}>
                    {r.fields.dozent_firstname ?? r.record_id}
                  </SelectItem>
                ))}
              </SelectContent>
            </Select>
