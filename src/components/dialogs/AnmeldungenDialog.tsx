...
export function AnmeldungenDialog({ open, onClose, onSubmit, defaultValues, teilnehmerList, kurseList, enablePhotoScan = true, enablePhotoLocation = true }: AnmeldungenDialogProps) {
  ...
  async function handlePhotoScan(file: File) {
    ...
    try {
      ...
      setFields(prev => {
        ...
        if (teilnehmerName) {
          const teilnehmerMatch = teilnehmerList.find(r => matchName(teilnehmerName!, [String(r.fields.teilnehmer_firstname ?? '')]));
              ...
              <SelectContent>
                ...
                {teilnehmerList.map(r => (
                  <SelectItem key={r.record_id} value={r.record_id}>
                    {r.fields.teilnehmer_firstname ?? r.record_id}
                  </SelectItem>
                ))}
              </SelectContent>
            </Select>
