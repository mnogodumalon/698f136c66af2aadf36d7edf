...
const DOZENTEN_FIELDS = [
  { key: 'dozent_firstname', label: 'Vorname', type: 'string/text' },
  { key: 'dozent_lastname', label: 'Nachname', type: 'string/text' },
...
const ANMELDUNGEN_FIELDS = [
  { key: 'teilnehmer', label: 'Teilnehmer', type: 'applookup/select', targetEntity: 'teilnehmer', targetAppId: 'TEILNEHMER', displayField: 'teilnehmer_firstname' },
...
const KURSE_FIELDS = [
  ...
  { key: 'dozent', label: 'Dozent', type: 'applookup/select', targetEntity: 'dozenten', targetAppId: 'DOZENTEN', displayField: 'dozent_firstname' },
];
const TEILNEHMER_FIELDS = [
  { key: 'teilnehmer_firstname', label: 'Vorname', type: 'string/text' },
  { key: 'teilnehmer_lastname', label: 'Nachname', type: 'string/text' },
  { key: 'email', label: 'E-Mail', type: 'string/email' },
  { key: 'telefon', label: 'Telefon', type: 'string/tel' },
...
export default function AdminPage() {
  ...
  const getApplookupDisplay = useCallback((entity: EntityKey, fieldKey: string, url?: unknown) => {
    ...
    if (entity === 'anmeldungen' && fieldKey === 'teilnehmer') {
      ...
      return match?.fields.teilnehmer_firstname ?? '—';
    }
    ...
    if (entity === 'kurse' && fieldKey === 'dozent') {
      ...
      return match?.fields.dozent_firstname ?? '—';
    }
    return String(url);
  }, [getLookupLists]);
